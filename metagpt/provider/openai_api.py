...
class CostManager(metaclass=Singleton):
    ...
    def update_cost(self, prompt_tokens, completion_tokens, model):
        ...
        logger.info(
            ...
            f"Current cost: ${cost:.3f}, prompt_tokens: {prompt_tokens} at {TOKEN_COSTS[model]['prompt']}, completion_tokens: {completion_tokens} at {TOKEN_COSTS[model]['completion']}"
        )
